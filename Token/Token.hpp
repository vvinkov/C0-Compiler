...
namespace C0Compiler
{
	...
	static std::vector<std::string> tokenString = 
	{
		...
		"FOR", "ASSERT", "ERROR", "ALLOC", "ALLOCARRAY", "IDENTIFIER", "DEKADSKI", 
		"HEKSADEKADSKI", "CHRLIT", "STRLIT", "BOOLEAN", "NUL", "BREAK", "CONTINUE", "RETURN", 
		"INT", "BOOL", "CHAR", "STRING", "VOID", "INTPOINT", "BOOLPOINT", "CHARPOINT", 
